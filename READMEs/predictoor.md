...
Select that unique id from the `sim_state` folder, and run `python sim_plots.py <unique_id>` e.g. `python sim_plots.py 97f9633c-a78c-4865-9cc6-b5152c9500a3`

You can run many instances of dash at once, with different URLs.
