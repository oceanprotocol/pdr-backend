...
from pdr_backend.grpmodel.test.resources import get_Xy_UP, get_Xy_DOWN


@enforce_types
def test_grpmodel_data_1dir():
    # build data
    ...
    data_UP = GrpmodelData1Dir(X_UP, ytrue_UP, ["x0", "x1"])
...
@enforce_types
def test_grpmodel_data_both_dirs():
    # build data
    (X_UP, ytrue_UP) = get_Xy_UP()
    ...
    assert isinstance(data[UP], GrpmodelData1Dir)
    assert isinstance(data[DOWN], GrpmodelData1Dir)
