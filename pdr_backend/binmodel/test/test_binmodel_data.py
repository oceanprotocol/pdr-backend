...
def test_binmodel_data_1dir():
    ...
    data_UP = BinmodelData1Dir(X_UP, ytrue_UP, ["x0", "x1"])
...
@enforce_types
def test_binmodel_data_both_dirs():
    # build data
    (X_UP, ytrue_UP) = get_Xy_UP()
    ...
    assert isinstance(data[UP], BinmodelData1Dir)
    assert isinstance(data[DOWN], BinmodelData1Dir)
