...
from pdr_backend.aimodel.resid import (
    ResidPlotdata,
    ResidPlotdataFactory,
    plot_resid,
)
...
def test_resid():
    ...
    d = ResidPlotdataFactory.build(y, nlags)
    assert isinstance(d, ResidPlotdata)
