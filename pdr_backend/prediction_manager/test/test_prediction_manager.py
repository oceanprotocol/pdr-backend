...
def test_transfer_erc20(prediction_manager: PredictionManager, ocean_token, web3_config):
    ...
    prediction_manager.transfer_erc20(ocean_token.contract_address, web3_config.owner, 100)
