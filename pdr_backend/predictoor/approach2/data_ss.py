...
from pdr_backend.predictoor.approach2.timeutil import pretty_timestr

CAND_USDCOINS = ["USDT", "TUSD", "DAI", "USDC"]  # add more if needed
...
class DataSS:
    ...
    def __init__(
        ...
        usdcoin: str,  # e.g. "TUSD", for pairs of eg ETH-TUSD, BTC-TUSD
        ...
        # TODO: not sure if these assertions and limitations are needed
