from pdr_backend.predictoor.main import process_block, log_loop, process_topic
import pdr_backend.predictoor.main as main
from unittest.mock import patch, Mock
from pdr_backend.utils.contract import PredictoorContract


@patch("pdr_backend.predictoor.main.get_all_interesting_prediction_contracts")
def test_predictoor_main_process_block(mock_topics):
    mock_topics.return_value = {"0x123": "topic"}

    with patch("pdr_backend.predictoor.main.process_topic") as mock_pt:
...
def test_predictoor_main_process_topic(monkeypatch):
    ...
    with patch("pdr_backend.predictoor.main.do_prediction") as mock_dp:
