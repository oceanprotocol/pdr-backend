...
def test_fund_dev_accounts(monkeypatch):
    ...
    fund_dev_accounts(accounts_to_fund, None, mock_token)

    mock_token.transfer.assert_has_calls(
        [
            call("0xBE5449a6A97aD46c8558A3356267Ee5D2731ab5e", 2e21, None),
            call("0xBE5449a6A97aD46c8558A3356267Ee5D2731ab5e", 3e21, None),
        ]
    )
