...
class PredictionMock:
    def __init__(self, pair, timeframe, source, timestamp, prediction, trueval, stake, payout):
        self.pair = pair
...
class TestWriteCSV(unittest.TestCase):
    ...
    def test_write_csv(self, mock_exists, mock_makedirs):
        all_predictions = [
            PredictionMock("BTC/USD", "1h", "binance", 1234567890, 55000.5, 55050.3, 1, 50),
            PredictionMock("BTC/USD", "1h", "binance", 1234567891, 55100.0, 55150.3, 2, 100),
        ]
        ...
        handle.write.assert_any_call('Predicted Value,True Value,Timestamp,Stake,Payout\n')
