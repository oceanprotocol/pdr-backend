...
@patch("pdr_backend.util.get_contract_predictions_info.get_cli_statistics")
@patch("pdr_backend.util.get_contract_predictions_info.get_all_contract_ids_by_owner")
@patch("pdr_backend.util.get_contract_predictions_info.fetch_filtered_predictions")
def test_get_contract_predictions_info_main_mainnet(
