...
@enforce_types
def fund_core_accounts_with_OCEAN(web3_pp: Web3PP):
    """
    ...
    fund_core_accounts(accounts_to_fund, web3_pp.web3_config.owner, OCEAN)
    print("Done funding.")


@enforce_types
def fund_core_accounts(accounts_to_fund: List[tuple], owner: str, token: Token):
